...
SRC_PATH=/Documents/GitHub/FFmpeg
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=gcc 4.7.1 (tdm-1)
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
CFLAGS=   -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
...
CFLAGS-ffplay=-Ic:/pspsdk/psp/include/SDL -Dmain=SDL_main 
ZLIB=-lz
...
libavutil_VERSION=52.67.100
libavutil_VERSION_MAJOR=52
libavutil_VERSION_MINOR=67
...
LIBS-ffplay=-Lc:/pspsdk/psp/lib -lSDLmain -lSDL -lm -lGL -lpspvfpu -Lc:/pspsdk/psp/sdk/lib -lpspirkeyb -lpsppower -lpspdebug -lpspgu -lpspctrl -lpspge -lpspdisplay -lpsphprm -lpspsdk -lpsprtc -lpspaudio -lc -lpspuser -lpsputility -lpspkernel -lpspnet_inet
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
