...
=item B<xvmc_acceleration> I<integer>B<>
...
=item I<arnr_strength>B<>

C<VP8E_SET_ARNR_STRENGTH>

=item I<rc_lookahead>B<>
...
=item B<-mpegts_original_network_id> I<number>B<>

Set the original_network_id (default 0x0001). This is unique identifier
of a network in DVB. Its main use is in the unique identification of a
service through the path Original_Network_ID, Transport_Stream_ID.

=item B<-mpegts_transport_stream_id> I<number>B<>

Set the transport_stream_id (default 0x0001). This identifies a
transponder in DVB.

=item B<-mpegts_service_id> I<number>B<>

Set the service_id (default 0x0001) also known as program in DVB.

=item B<-mpegts_pmt_start_pid> I<number>B<>

Set the first PID for PMT (default 0x1000, max 0x1f00).

=item B<-mpegts_start_pid> I<number>B<>

Set the first PID for data packets (default 0x0100, max 0x0f00).

=item B<-mpegts_m2ts_mode> I<number>B<>

Enable m2ts mode if set to 1. Default value is -1 which disables m2ts mode.

=item B<-muxrate> I<number>B<>

Set muxrate.

=item B<-pes_payload_size> I<number>B<>
...
=item B<-mpegts_copyts> I<number>B<>

Preserve original timestamps, if value is set to 1. Default value is -1, which
results in shifting timestamps so that they start from 0.

=item B<-tables_version> I<number>B<>
...
=item B<listen_timeout=>I<microseconds>B<>
